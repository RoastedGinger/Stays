    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
              String  manname = (String) dataSnapshot.child("Name").getValue();
                String phj = (String) dataSnapshot.child("Phone").getValue();
                String gh = (String) dataSnapshot.child("Email").getValue();
                formemail.setText(gh);
                formname.setText(manname);
                formphone.setText(phj);
