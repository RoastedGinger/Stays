...
public class Mangan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if (ps.equals("pritz@gmail.com")) {
                    ...
                    add.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            Intent i = new Intent(Mangan.this, Admin.class);
                            i.putExtra("keyroot","Mangan");
                            startActivity(i);
                        }
                    });
                }
        ...
        mdatabase = FirebaseDatabase.getInstance().getReference().child("Mangan");
        ...
        FirebaseRecyclerAdapter<gtr, East.BlogViewholder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<gtr, East.BlogViewholder>(gtr.class,R.layout.design2,East.BlogViewholder.class,mdatabase) {
            ...
            protected void populateViewHolder(East.BlogViewholder viewHolder, gtr model, int position) {
                ...
                viewHolder.view.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Toast.makeText(Mangan.this, "Loading details...", Toast.LENGTH_LONG).show();
                        mdatabase.child(pskey).addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                Intent intent = new Intent(Mangan.this, Main2Activity.class);
                                intent.putExtra("message", pskey);
                                intent.putExtra("keyroot","Mangan");
